...
La dimensione dei blocchi e la larghezza di banda influenzano direttamente il numero di IOPS. All'aumentare delle dimensioni dei blocchi, il sistema incrementa la larghezza di banda fino al livello necessario per elaborare blocchi di dimensioni maggiori. All'aumentare della larghezza di banda, il numero di IOPS che il sistema è in grado di raggiungere diminuisce. Consulta  https://www.netapp.com/pdf.html?item=/media/10502-tr-4644.pdf["Qualità del servizio SolidFire"^] per ulteriori informazioni su QoS e prestazioni.
