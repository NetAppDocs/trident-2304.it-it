...
.Esempio di configurazione minima SAN ONTAP
[%collapsible%open]
====
...
----
====
.Esempio di configurazione minima di ONTAP SAN economy
[%collapsible%open]
====
[listing]
----
