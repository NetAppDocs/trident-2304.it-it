...
* Un problema comune che potresti incontrare quando usi Trident https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"] è quando i tenant e i client secrets provengono da una registrazione di app con autorizzazioni insufficienti. Per un elenco completo dei requisiti di Trident, consulta link:../trident-use/anf.html["Azure NetApp Files"] la configurazione.
