...
[%collapsible%open]
====
Per ulteriori informazioni sul distacco forzato, fai riferimento a link:kubernetes-customize-deploy.html["Personalizzare l'installazione dell'operatore Trident"].
